...
export class LoginPage {
  ...
  constructor(page: Page) {
    ...
    this.accountDropdown = page.locator('.dropdown').filter({ hasText: 'My Account' });
    this.logoutButton = this.accountDropdown.getByRole('link', { name: 'Logout' });

    this.myOrdersSection = page.getByText('My orders');
  }
